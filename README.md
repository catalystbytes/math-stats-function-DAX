...
## 🧩 Example 2: Iterator-Based Metrics – One-Page DAX

This DAX table summarizes results using row-level iterator functions grouped by product, store, customer, and customer type.
